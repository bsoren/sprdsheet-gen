 ...
 * @author bsoren
 */
public class StartingNode extends NodeElement {
        
        int progress = 0;

        public StartingNode(Node node, StringBuilder builder) {
                super(node, builder);

        }

        public StartingNode(FileProcessTask sgb, Node node, StringBuilder builder) {
...
//        }
        ...
        public void processNode() {
                ...
                for (int temp = 0; temp < suElements.getLength(); temp++) {
                       ...
                       sgb.setProgressValue((int)(temp * 100)/(suElements.getLength()-1));
